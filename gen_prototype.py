...
def gen_prototype(num_labels, km_models):
    ...
    for label in range(num_labels):
        ...
        if hasattr(model, 'cluster_centers_'):
            ...
            prototype[label] = (image_centers, caption_centers)
            real_num_labels += 1
        else:
            print(f"Warning: {model_name} has no attribute cluster_centers_")
    return prototype, real_num_labels
...
def main():
    ...
    prototype, num_labels = gen_prototype(args.num_label_clusters, fitted_km)
