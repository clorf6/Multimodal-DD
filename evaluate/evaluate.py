...
def train_and_evaluate():
    ...
    parser.add_argument('--train_dataset', default='coco_sync', type=str, help='data to train for eval model')
    parser.add_argument('--train_image_size', default=224, type=int, help='image size')
    parser.add_argument('--train_time_str', default='Tue-Dec-17-18-00-22-2024', type=str, help='time string')
    ...
    parser.add_argument('--train_image_encoder', type=str, default='nfnet', choices=['clip', 'nfnet', 'vit', 'nf_resnet50'], help='image encoder')
    ...
    parser.add_argument("--train_is_normalize", default=False, type=bool, help="use data normalization")
    ...
    parser.add_argument('--test_dataset', default='coco', type=str, help='data for testing')
