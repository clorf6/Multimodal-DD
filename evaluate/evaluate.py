...
def train_and_evaluate():
    ...
    parser.add_argument('--image_lr', default=0.0005, type=float,
                        help='learning rate')
    parser.add_argument('--text_lr', default=0.0005, type=float,
                        help='learning rate')
    parser.add_argument('--dataset', default='coco_sync', type=str,
    ...
    parser.add_argument('--eval_epoch', type=int, default=10, help='None')
